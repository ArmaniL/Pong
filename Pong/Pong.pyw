...
class Ball:
 ...
 def update(self,paddle,opp_Paddle):
          ...
          if (paddle_hitbox.colliderect(ball_hitbox)):
          	  Ball.vx=0.15
          if (opp_Paddle_hitbox.colliderect(ball_hitbox)):
          	  Ball.vx=-0.15
...
while True:
 ...
 paddle.draw(DISPLAY)
 pygame.draw.line(DISPLAY,(255,255,255,230),(0,height),(width,height),2)
 ball.draw(DISPLAY)
